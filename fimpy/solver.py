...
try:
    ...
    print("Import of Cupy failed. The GPU version of fimpy will be unavailble. Message: %s" % (err))
...
available_arr_t = (Union[np.ndarray, cp.ndarray] if cupy_available else Union[np.ndarray])

class FIMPY():
    #"""Factory class responsible for creating the correct Fast Iterative Method solver
    #"""
    @staticmethod
